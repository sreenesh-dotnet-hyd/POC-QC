...
export default function SelectedSampleSlidesTable({ sampleSlides, onView, onEdit, onDelete }: { sampleSlides: Slide[], onView:(slide:Slide)=>void, onEdit:(slide:Slide)=>void, onDelete:(slide:Slide)=>void}) {
