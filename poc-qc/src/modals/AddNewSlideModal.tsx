...
import type { Slide } from "../types/sample.types"
...
export default function AddNewSlideModal({
    ...
    const [formData, setFormData] = useState<Slide>({
        slideId: "",                  // barcode or generated later
        sampleId: "",                 // must be selected from sample

        slideType: "",                // e.g. H&E, QC
        stainType: null,

        createdAt: new Date(),        // set at creation time
        createdBy: "",                // fill from logged-in user
        createdMethod: "MANUAL",      // default

        status: "CREATED",            // initial slide status
        isBlocked: false,
        ...
        timeline: []                  // will push first CREATED event
    });
